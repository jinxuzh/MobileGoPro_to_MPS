...
from utils.utils import decode_video_to_images

"""
Human work has to be involved in extract_images.py to:
    - Extract aria raw images (stop when walkaround is finished)
    - Select the start and end frame to separate out walkaround frames
"""
